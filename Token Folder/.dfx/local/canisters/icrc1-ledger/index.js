...
import { idlFactory } from './icrc1-ledger.did.js';
export { idlFactory } from './icrc1-ledger.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICRC1_LEDGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icrc1-ledger.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icrc1-ledger canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icrc1-ledger.did.js")._SERVICE>}
 */
export const icrc1_ledger = createActor(canisterId);
